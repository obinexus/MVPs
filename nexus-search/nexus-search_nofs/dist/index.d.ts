...
export { CacheError, CacheStrategyType, ConfigError, IndexError, MapperError, NexusSearch, PerformanceError, SearchError, SearchEventError, StorageError, ValidationError, NexusSearch as default, isIndexConfig, isSearchOptions, isSearchResult };
export type { AdvancedSearchOptions, ArrayValue, BaseEvent, BaseFields, CacheEntry, CacheOptions, CacheStatus, CacheStrategy, CreateDocumentOptions, DatabaseConfig, DocumentBase, DocumentConfig, DocumentContent, DocumentLink, DocumentMetadata, DocumentRank, DocumentRelation, DocumentScore, DocumentStatus, DocumentValue, DocumentVersion, DocumentWorkflow, ErrorEvent, ExtendedSearchOptions, IndexConfig, IndexNode, IndexOptions, IndexableFields, IndexedDocument, IndexedDocumentData, MapperOptions, MapperState, MetadataEntry, MetricsResult, NexusDocument, NexusDocumentInput, NexusDocumentMetadata, NexusDocumentPluginConfig, NexusFields, NormalizedDocument, OptimizationOptions, OptimizationResult, PerformanceMetric, PrimitiveValue, QueryToken, RegexSearchConfig, RegexSearchResult, RelationType, ScoringMetrics, Search, SearchContext, SearchDBSchema, SearchEngineConfig, SearchEngineOptions, SearchEvent, SearchEventEmitter, SearchEventListener, SearchEventType, SearchMatch, SearchNode, SearchOptions, SearchPagination, SearchResult, SearchScoreParams, SearchStats, SearchableDocument, SearchableField, SerializedIndex, SerializedState, SerializedTrieNode, StorageConfig, StorageEntry, StorageOptions, StorageOptionsConfig, SuccessEvent, TextScore, TokenInfo, TrieSearchOptions, ValidationConfig, VersioningConfig };
